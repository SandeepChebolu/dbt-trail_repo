with blv_mdm_sapcustomer_qv_source as (
       ...
       rank_1 as (
        select accountid,
         ...
         where rank_1_inner.accountcustomer_rank <= 1
       ),
       aggregation_1 as (
       ...
       j_custcustsales as (
        select j_custaccount.client as client,
               ...
               cast(iff((cms_winnercustomercount is null),0,cms_winnercustomercount) as INTEGER) as winnercustomercount,
               left(cast(iff(winnercustomercount = 1,cms_winnercustomernumber,customernumber) as NVARCHAR), 10) as winnercustomernumber
          from j_custaccount
