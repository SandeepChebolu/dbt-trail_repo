with blv_mdm_sapcustomer_qv_source as (
       ...
       rank_1 as (
        ...
        qualify accountcustomer_rank <= 1
       ),
       aggregation_1 as (
       ...
       j_custcustsales as (
        select j_custaccount.client as client,
               ...
               left(cast(iff(winnercustomercount = 1,j_custaccount.cms_winnercustomernumber,j_custaccount.customernumber) as NVARCHAR), 10) as winnercustomernumber -- ambigious column name customernumber 
          from j_custaccount
