...
*/ with a_createmapcolumn as (
       ...
       join_2 as (
        select union_1.csd_sourcesalesgroupingnumber as sourcesalesgroupingnumber, 
               ...
               left(cast(iff((calc_globalgroupingnumber_hide = '' or (calc_globalgroupingnumber_hide is null)) and (calc_nationalgroupingnumber_hide = '' or (calc_nationalgroupingnumber_hide is null)) and (calc_salesgroupingnumber_hide = '' or (calc_salesgroupingnumber_hide is null)),union_1.customernumber,calc_salesgroupingnumber_hide) as NVARCHAR), 10) as salesgroupingnumber, 
               left(cast(iff((calc_globalgroupingnumber_hide = '' or (calc_globalgroupingnumber_hide is null)) and (calc_nationalgroupingnumber_hide = '' or (calc_nationalgroupingnumber_hide is null)) and (calc_salesgroupingnumber_hide = '' or (calc_salesgroupingnumber_hide is null)),union_1.customernumber,calc_nationalgroupingnumber_hide) as NVARCHAR), 10) as nationalgroupingnumber, 
